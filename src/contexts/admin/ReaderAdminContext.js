...
const ReaderAdminContext = createContext();
const ReaderAdminContextProvider = (props) => {
...
ReaderAdminContextProvider.propTypes = {
    children: PropTypes.node.isRequired
};

export { ReaderAdminContextProvider, ReaderAdminContext };
