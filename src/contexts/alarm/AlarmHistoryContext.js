...
const AlarmHistoryContext = createContext();
const AlarmHistoryContextProvider = (props) => {
...
AlarmHistoryContextProvider.propTypes = {
    children: PropTypes.node.isRequired
};

export { AlarmHistoryContextProvider, AlarmHistoryContext };
