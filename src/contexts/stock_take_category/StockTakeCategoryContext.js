...
const StockTakeCategoryContext = createContext();
const StockTakeCategoryContextProvider = (props) => {
    ...
    return (
        <StockTakeCategoryContext.Provider
            value={{
                setRecords,
...
StockTakeCategoryContextProvider.propTypes = {
    children: PropTypes.node.isRequired
};

export { StockTakeCategoryContextProvider, StockTakeCategoryContext };
