...
const ReaderStatusContext = createContext();
const ReaderStatusContextProvider = (props) => {
...
ReaderStatusContextProvider.propTypes = {
    children: PropTypes.node.isRequired
};

export { ReaderStatusContextProvider, ReaderStatusContext };
